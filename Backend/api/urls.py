...
urlpatterns = [
    ...
    path('accounts/forgot_password2', views.Users.forgot_password),
    path('accounts/forgot_password', views.ForgotPasswordView.as_view()),
    ...
    path('exam_list2', views.Dashboard.exam_list),
    path('exam_list', views.ExamListView.as_view()),
    ...
    path('examine/add_question2', views.Examine.add_question),
    path('examine/add_question', views.AddQuestionView.as_view()),
    path('examine/question', views.Examine.question),
    path('examine2/question2', views.QuestionView.as_view()),
    path('examine/edit_question2', views.Examine.edit_question),
    path('examine/edit_question', views.EditQuestionView.as_view()),
    path('examine2/result_list2', views.Examine.result_list),
    path('examine/result_list', views.ResultListView.as_view()),
